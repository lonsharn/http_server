...
var Info = {
	...
	bindEvent : function(){
		...
		//鼠标按下
		info.ontouchstart = function(e){
            e.preventDefault()
            var touch = e.touches[0]
			var x = touch.clientX-500,
				y = touch.clientY,xIndex,yIndex;
            //遍历右侧的塔位置
		...
		info.ontouchend = function(){
			Canvas.clear(cxt,500,500);
			select.ontouchmove = null;
			select.ontouchend = null;
		};
	},
    //更新金钱
